...
<span sytle="font-size: 40px;">I was able to bring home an old Dell Inspiron Desktop PC that was at one point used in my school's library, as it had not been used for some time and was of no use to the school.
...
test I didn't see any noticable performance problems when connecting remotely and everything worked the same as it had on the local network.</span> 
